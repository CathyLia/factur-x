                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <form method="post" enctype="multipart/form-data">
                                <div class="card">
                                    <div class="card-header bg-info text-white">
                                        Générer un PDF Factur-X à partir d'un PDF et d'un XML Factur-X
                                    </div>
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>Ajout PDF</label>
                                            <input type="file" class="form-control-file" name="pdf_classic" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Votre fichier XML</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label>Choisissez la relation d'embarquement du fichier XML Factur-X</label>
                        ...
                        <div class="col-md-4">
                            <form method="post" enctype="multipart/form-data">
                                <div class="card">
                                    <div class="card-header bg-info text-white">Extraire le fichier XML dans PDF</div>
                                    <div class="card-body">
                                        <div class="form-group">
                                            <!-- <label>Choose the PDF file containing the Factur-X XML to extract :</label> -->
                                            <label>Choisissez le fichier PDF contenant le XML Factur-X à extraire :</label>
                        ...
                        <div class="col-md-4">
                            <form method="post" enctype="multipart/form-data">
                                <div class="card">
                                    <div class="card-header bg-info text-white">Vérifier le fichier XML Factur-X</div>
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>Choisissez le fichier XML Factur-X pour vérifier :</label>
